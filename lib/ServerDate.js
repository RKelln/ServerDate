...
ServerDate.sync = function(cb, syncTimeoutDuration) {
  synchronize(cb, syncTimeoutDuration);
};
...
function synchronize(cb, syncTimeoutDuration) {
  var iteration = 1,
    completed = false,
    pendingCallback = cb,
